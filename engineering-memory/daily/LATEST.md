...
- Commits:
- 102a608 feat(profile): store primary and secondary skill type on user skills — atultiwari
- Changed files:
- added: prisma/migrations/20260925000000_add_user_skill_type/migration.sql
