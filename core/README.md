...
- **[jobfynder-chrome-extension.md](./jobfynder-chrome-extension.md)** — the current implementation record for the Manifest V3 Recruiting Companion: roles, authentication, governance, capture, matching, Skill Intelligence, submissions, NRM, Messenger, LinkedIn safeguards, API contracts, validation, and production gates.
